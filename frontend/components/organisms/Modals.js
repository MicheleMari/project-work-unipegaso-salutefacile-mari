        ...
        <div class="pointer-events-auto bg-white rounded-xl w-full max-w-2xl border border-slate-200 flex flex-col max-h-[90vh] transform scale-95 transition-all">
            ...
            <form id="triage-form" data-role="triage-form" class="p-6 space-y-6 overflow-y-auto bg-white rounded-b-xl">
                ...
                <div>
                    ...
                    <div id="exams-grid" class="grid grid-cols-2 gap-3 max-h-48 overflow-y-auto pr-1">
                        <!-- Exam items same as previous -->
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="ECG" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-red-100 text-red-600 flex items-center justify-center shrink-0"><i data-lucide="heart-pulse" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">ECG</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="Stick Urine" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center shrink-0"><i data-lucide="flask-conical" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Stick Urine</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="EGA" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center shrink-0"><i data-lucide="droplet" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Emogas (EGA)</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="Prelievo" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-red-100 text-red-600 flex items-center justify-center shrink-0"><i data-lucide="syringe" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Prelievo Ematico</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="Tampone Covid" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center shrink-0"><i data-lucide="thermometer" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Tampone Covid</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="RX Torace" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center shrink-0"><i data-lucide="image" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">RX Torace</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="Glucometria" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-pink-100 text-pink-600 flex items-center justify-center shrink-0"><i data-lucide="activity" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Glucometria</span></div></label>
                        <label class="cursor-pointer block relative group exam-item"><input type="checkbox" name="exams" value="Alcol Test" class="peer sr-only"><div class="p-3 rounded-lg border-2 border-slate-100 flex items-center gap-3 transition-all peer-checked:border-medical-500 peer-checked:bg-medical-50 hover:bg-slate-50"><div class="w-8 h-8 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center shrink-0"><i data-lucide="beer" class="w-4 h-4"></i></div><span class="font-bold text-slate-700 text-xs">Alcol Test</span></div></label>
                    </div>
                </div>
